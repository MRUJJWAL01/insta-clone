...
export const profile = () => {
  ...
  return (
    <div className="w-6 h-6 overflow-hidden rounded-full bg-red-500">
      <img src={user.dp} className="bg-center object-contain" alt="" />
    </div>
  );
};
...
export const InstaMiniLogo = () => (
  <svg
    aria-label="Instagram"
    className="x1lliihq x1n2onr6 x5n08af transition-transform"
    fill="currentColor"
    height="24"
    role="img"
    viewBox="0 0 24 24"
