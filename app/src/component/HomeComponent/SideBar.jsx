...
const SideBar = () => {
  ...
  const handleMetaClick = () => {
    setActiveMenu(activeMenu === "meta" ? null : "meta");
  };
  ...
  return (
    <div className="flex h-screen bg-gray-100">
      {/* Sidebar */}
      <div
        className={`bg-black text-white transition-all duration-75 ${
          isCollapsed ? "w-18" : "w-60"
        } flex flex-col border-r border-gray-800 relative`}
      >
        {/* Logo */}
        <div  className="mt-6 mb-4">
          {!isCollapsed ? (
            <div  className="flex  cursor-pointer pr-22 mt-4">
              <svg
            ...
            <div className=" ml-6   cursor-pointer transition-transform duration-100   mt-4 ">
              <svg  
                aria-label="Instagram"
          ...
          {navLinks.map((link) => {
            ...
            return (
              <div
                ...
                className="w-full flex cursor-pointer items-center gap-4 px-6 py-3 hover:bg-gray-900 transition-colors"
              >
        ...
        {/* Bottom Links */}
        <div className="mb-4 mt-[7.3vw]">
          <button
            onClick={handleMoreClick}
            className={`w-full cursor-pointer flex items-center gap-4 px-6 py-3 hover:bg-gray-900 transition-colors ${
              isCollapsed ? "" : ""
            }`}
          >
            <span>
          ...
          <button
            ...
            className={`w-full mt-2 cursor-pointer flex items-center gap-4 px-6 py-3 hover:bg-gray-900 transition-colors ${
              isCollapsed ? "" : ""
            }`}
          >
            <span>
