  ...
  return (
    <div className="flex items-center justify-center p-4 ">
      <div className="w-full max-w-sm pt-12 px-5">
        ...
        <div className="bg-black border border-[#363636] rounded-xs p-8 mb-4">
          {/* Instagram logo */}
          <div className="text-center mb-8 flex justify-center items-center">
            {/* SVG omitted for brevity */}
            <svg
              aria-label="Instagram"
              className="x1lliihq x1n2onr6 x5n08af text-shadow-xs shadow-white"
              fill="white"
              height="80"
              role="img"
              viewBox="32 4 113 32"
        ...
        {/* Sign up container */}
        <div className="bg-black border border-[#363636] rounded-xs p-4 text-center">
...
//               <button
//                 onClick={handleLogin}
//                 className="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-4 rounded text-sm transition-colors duration-200"
//               >
//                 Log in
//               </button>
//             </form>
...
//           {/* Facebook login */}
//           <button className="w-full flex items-center justify-center space-x-2 text-blue-400 font-semibold text-sm mb-6 hover:text-blue-300 transition-colors duration-200">
...
//             <span
//               onClick={() => setToggle((prev) => !prev)}
//               className="text-blue-400 cursor-pointer font-semibold hover:text-blue-300 transition-colors duration-200"
//             >
//               Sign up
//             </span>
//           </p>
